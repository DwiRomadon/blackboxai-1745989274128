...
<body class="bg-gray-100 p-6">
    <div class="container mx-auto max-w-lg">
        ...
        <form action="/customer/create" method="POST" class="bg-white p-6 rounded shadow">
            <div class="mb-4">
            ...
            <div class="flex justify-between">
                ...
                <button type="submit" class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700 transition">Add Customer</button>
            </div>
        </form>
    </div>
</body>
